          ...
          <CardContent>
            <div className={classes.root}>
              <Grid container spacing={24}>
                ...
                {props.weatherData.consolidated_weather &&
                  props.weatherData.consolidated_weather.map((item, index) => {
                    if (index < 5)
                      return (
                        <Grid
                        ...
                        >
                          ...
                          {index != 0 && index != 1 ? (
                            <h4>
                              {
                                weatherData.consolidated_weather[index]
                                  .applicable_date
                              }
                            </h4>
                          ) : (
                          ...
                          >
                            Min :{" "}
                            {Math.floor(
                              weatherData.consolidated_weather[index].min_temp
                            ) + "°C"}
                          </Typography>
                          <Typography
                            className={classes.title}
                          ...
                          >
                            Max :{" "}
                            {Math.floor(
                              weatherData.consolidated_weather[index].max_temp
                            ) + "°C"}
                          </Typography>
                        </Grid>
                      );
